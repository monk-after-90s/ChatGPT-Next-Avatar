...
OPENAI_API_KEY=$OPENAI_API_KEY CODE=$CODE PORT=$PORT DIGMAN_BASEURL=$DIGMAN_BASEURL yarn build
OPENAI_API_KEY=$OPENAI_API_KEY CODE=$CODE PORT=$PORT DIGMAN_BASEURL=$DIGMAN_BASEURL yarn start
